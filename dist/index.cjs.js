...
var reactComplexTree = require('react-complex-tree');
require('react-complex-tree/lib/style.css');
...
var events = modeluiCoreRuntime.structs.TreeBase.events;
var triggers = modeluiCoreRuntime.structs.TreeBase.triggers;
var options = {
  "id": "tree-complex",
...
var config = {
  ...
  options: options,
  state: modeluiCoreRuntime.structs.TreeBase.StateTree
}; // styles
// event handler
...
var ComplexTreeComponent = /*#__PURE__*/function (_structs$TreeBase$Tre) {
  ...
  _createClass(ComplexTreeComponent, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default["default"].createElement(reactComplexTree.ControlledTreeEnvironment, {
        canDragAndDrop: true,
      ...
      }, /*#__PURE__*/React__default["default"].createElement(reactComplexTree.Tree, {
        treeId: "tree-1",
        rootItem: "root",
...
}(modeluiCoreRuntime.structs.TreeBase.TreeBase);

function ComplexTree(props) {
  // lets enumerate schema to extract uiSchema and validation
  return /*#__PURE__*/React__default["default"].createElement(ComplexTreeComponent, props);
}
